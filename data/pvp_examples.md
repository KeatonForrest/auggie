# PVP Email Sequences: Master Reference

50 complete PEA sequences across SaaS verticals, MSP use cases, and partial-signal scenarios. Each demonstrates how to turn an Existential Data Point into a three-email sequence using research as proof of understanding.
...
- Target persona
- Existential Data Point with threshold
- Data Cocktail (2-3 public signals combined)
- Three emails: PREVIEW, ENGAGE, ASK
- Word counts within limits (75/100/60)

**The pattern:**
- PREVIEW: Earn the open with specific insight
- ENGAGE: Prove you've solved this with quantified outcomes
- ASK: Make a low-friction offer, mention product briefly

**The principle:**
Research is proof of understanding, not the point. Every email answers: "Why should they believe we can help with their specific problem?"

**Two sections:**
- Section A (Examples 1-40): Full-Confidence PVPs with multiple confirming signals
- Section B (Examples 41-50): Partial-Signal PVPs for incomplete, ambiguous, or unconfirmed data
